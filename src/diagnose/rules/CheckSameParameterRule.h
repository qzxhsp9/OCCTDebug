...
class CheckSameParameterRule final : public IDiagnosticRule
{
public:
    std::string id() const override { return "R402"; }
    std::string name() const override { return "SameParameter flag"; }
